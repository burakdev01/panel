      ...
      <div class="border-b border-gray-200 px-6 py-4">
        <div class="flex flex-wrap gap-2">
          ...
          <button type="button" data-lang-tab="<?= esc($language['id']) ?>"
            class="lang-tab px-4 py-2 rounded-full text-sm font-medium transition border border-transparent hover:bg-gray-100 <?= $index === 0 ? 'bg-blue-50 text-blue-600 border-blue-200' : 'text-gray-600' ?>">
            <?= esc($language['name']) ?>
          </button>
          <?php endforeach; ?>
        </div>
