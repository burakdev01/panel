<div class="space-y-6">
  <div class="bg-white rounded-2xl shadow-sm border border-gray-200">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between px-6 py-5 border-b border-gray-200 space-y-4 md:space-y-0">
      <div>
        ...
        <p class="text-sm text-orange-600 mt-2">Slider ekleyebilmek için önce dil tanımlamalısınız.</p>
        <?php endif; ?>
      </div>
